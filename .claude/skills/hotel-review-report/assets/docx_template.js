...
// TODO: CUSTOMIZE - レビュー基本情報
const REVIEW_COUNT = "XX件（重複除外後）";
const TARGET_SITES = "対象サイト：Booking.com / Trip.com / じゃらん / 楽天トラベル / Agoda / Google";

// TODO: CUSTOMIZE - KPIカードの値
const KPI_CARDS = [
...
// TODO: CUSTOMIZE - エグゼクティブサマリーのテキスト
...
// TODO: CUSTOMIZE - サイト別レビューデータ
// 各行: [サイト名, 件数, ネイティブ平均, 尺度, 10pt換算, 中央値(10pt), 判定]
const SITE_DATA = [
...
// TODO: CUSTOMIZE - 強みテーマデータ
// 各行: [テーマ名, 言及数テキスト, 代表的コメント]
...
const STRENGTH_SUB_1_TITLE = "3.1 最大の強み：「【強み名】」";
const STRENGTH_SUB_1_TEXT = "【最大の強みの説明テキスト】";
...
const STRENGTH_SUB_2_TITLE = "3.2 【第2の強みタイトル】";
const STRENGTH_SUB_2_TEXT = "【第2の強みの説明テキスト】";

// TODO: CUSTOMIZE - 弱み分析データ（優先度マトリクス）
// 各行: [優先度(S/A/B/C), 課題カテゴリ, 具体的内容, 影響度テキスト]
...
// TODO: CUSTOMIZE - 改善施策 Phase 1（即座対応）
...
// TODO: CUSTOMIZE - 改善施策 Phase 2（短期）
...
// TODO: CUSTOMIZE - 改善施策 Phase 3（中期）
